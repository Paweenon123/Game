...
public class Bts extends JFrame implements ActionListener{
    ...
    Bts(){
    	...
    	ImageIcon image2 = new ImageIcon("bts1.png");
...
class Bpq2 implements ActionListener {
    ...
    Bpq2(){
    	...
    	ImageIcon image2 = new ImageIcon("bts2.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        JLabel label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq3 implements ActionListener{
    ...
    Bpq3(){
    	...
    	ImageIcon image2 = new ImageIcon("bts3.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq4  implements ActionListener{
    ...
    Bpq4(){
    	...
    	ImageIcon image2 = new ImageIcon("bts4.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Result1 {
	Result1(){
        ...
        ImageIcon image2 = new ImageIcon("b1.png");
        Border border = BorderFactory.createLineBorder(Color.gray,5);
        label1 = new JLabel();
