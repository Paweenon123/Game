...
public class Bpq1 extends JFrame implements ActionListener{
    ...
    Bpq1(){
    	...
    	ImageIcon image2 = new ImageIcon("bq1.png");
        ...
        bt1.setText("As if it's your last");
...
class Bpq2 implements ActionListener {
    ...
    Bpq2(){
    	...
    	ImageIcon image2 = new ImageIcon("bq2.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        JLabel label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq3 implements ActionListener{
    ...
    Bpq3(){
    	...
    	ImageIcon image2 = new ImageIcon("bq3.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq4  implements ActionListener{
    ...
    Bpq4(){
    	...
    	ImageIcon image2 = new ImageIcon("bq4.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Result1 {
	Result1(){
        ...
        ImageIcon image2 = new ImageIcon("w1.png");
        Border border = BorderFactory.createLineBorder(Color.gray,5);
        label1 = new JLabel();
