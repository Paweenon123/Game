...
public class Treasure extends JFrame implements ActionListener{
    ...
    Treasure(){
    	...
    	ImageIcon image2 = new ImageIcon("ts1.png");
...
class Bpq2 implements ActionListener {
    ...
    Bpq2(){
    	...
    	ImageIcon image2 = new ImageIcon("ts2.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        JLabel label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq3 implements ActionListener{
    ...
    Bpq3(){
    	...
    	ImageIcon image2 = new ImageIcon("ts3.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Bpq4  implements ActionListener{
    ...
    Bpq4(){
    	...
    	ImageIcon image2 = new ImageIcon("ts4.png");
        //Border border = BorderFactory.createLineBorder(Color.gray,5);
        label = new JLabel();
        label.setIcon(image2); //set pic 555.png
        label.setVerticalAlignment(JLabel.TOP);
...
class Result1 {
	Result1(){
        ...
        ImageIcon image2 = new ImageIcon("tsw.png");
        Border border = BorderFactory.createLineBorder(Color.gray,5);
        label1 = new JLabel();
